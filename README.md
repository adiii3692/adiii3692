...
<p align="left">
    <img src="https://skillicons.dev/icons?i=html,css,js,bootstrap,tailwind,sass,c,cpp,cs,python,java,react,nodejs,express,npm,django,flask,mongodb,mysql,postgresql,sqlite,typescript,git,bash,nextjs,threejs,vim,neovim,linux,arch,ubuntu,debian,cypress,jest,playwright,dotnet,postman,prisma,arduino,raspberrypi,jenkins,githubactions,docker,kubernetes,aws,azure&theme=light" width="60%"/>
</p>

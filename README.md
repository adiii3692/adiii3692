...
<p align="left">
    <img src="https://skillicons.dev/icons?i=html,css,js,bootstrap,tailwind,sass,c,cpp,cs,python,java,react,nodejs,express,npm,mongodb,mysql,postgresql,sqlite,typescript,git,bash,nextjs,threejs,docker,kubernetes,vim,linux,arch,cypress,jest,dotnet,postman,prisma,kali" width="60%"/>
</p>
